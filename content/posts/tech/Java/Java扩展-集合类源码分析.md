+++
date = '2025-04-04T14:11:11+08:00'
draft = false
title = 'Java扩展 集合类源码分析'
slug = "wkegtysq48"
description = "Java扩展 集合类源码分析"
categories = ["📒开发"]
tags = ["Java"]
summary = "Java扩展 集合类源码分析"
comments = true  
+++
## 1. ArrayList 源码分析
...
> ![ArrayList增加元素说明](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202410251042276_c5bc7a.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202410251042277_58fb8e.webp)

#### 2.2.3. JDK1.8 解决哈希冲突

相比于之前的版本，jdk1.8 在解决哈希冲突时有了较大的变化，当链表长度大于阈值（默认为 8）并且数组长度达到 64 时，将链表转化为红黑树，以减少搜索时间。

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202410251042278_a9e969.webp)
...
![HashMap源码分析.drawio - putVal方法流程图](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202410251042279_18ec1d.webp)
...
![HashMap源码分析.drawio - resize扩容流程](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202410251042280_9f1ffc.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202410251042281_b50488.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202410251042282_99ca43.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202410251042283_ac5b73.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202410251042284_3886d9.webp)

2. 线程2扩容后，由于头插法，链表顺序颠倒，但是线程1的临时变量 e 和 next 还引用了这两个节点

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202410251042285_38212c.webp)

3. 第1次循环。由于线程2 迁移的时候，已经把 B 的 next 指向了 A

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202410251042286_722e2b.webp)

4. 第2次循环

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202410251042287_e57e44.webp)

5. 第3次循环

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202410251042288_eb4e23.webp)
