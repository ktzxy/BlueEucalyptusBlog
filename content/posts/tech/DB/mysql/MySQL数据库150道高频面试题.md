...
#### 1.1.1. InnoDB索引与MyISAM索引实现的区别是什么？
...
![image-20220709183820796](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171220655.webp)

#### 1.1.2. 一个表中如果没有创建索引，那么还会创建B+树吗？
...
![image-20220709071051043](D:\Mynotebookblog\test\assets\202410251103554.png)
...
![image-20220709071958145](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171227377.webp)

把一些记录放到页里的示意图就是（这里一页就是一个磁盘块，代表一次IO）：

![image-20220709072138395](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171230067.webp)
...
![image-20220709073749310](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171234229.webp)
...
![image-20220709073749310](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171237707.webp)

![img](assets/202410251103559.png)
...
![image-20220709080648851](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171243463.webp)

#### 1.2.3. 聚簇索引与非聚簇索引b+树实现有什么区别？
...
![image-20220709130937991](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171257018.webp)
...
![image-20220709134109900](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171301513.webp)

#### 1.2.4. 说一下B+树中聚簇索引的查找（匹配）逻辑

![image-20220709080648851](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171304627.webp)

#### 1.2.5. 说一下B+树中非聚簇索引的查找（匹配）逻辑
...
![image-20220709130937991](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171307538.webp)

#### 1.2.6. 平衡二叉树，红黑树，B树和B+树的区别是什么？都有哪些应用场景？
...
![image-20220708235509010](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171311642.webp)
...
![image-20220708233351509](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171319417.webp)

为了提高查询效率，就需要 减少磁盘IO数 。`为了减少磁盘IO的次数，就需要尽量降低树的高度` ，需要把原来“瘦高”的树结构变的“矮胖”，树的每层的分叉越多越好。针对同样的数据，如果我们把二叉树改成 三叉树：

![image-20220708235725124](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171326059.webp)
...
![image-20220708231622916](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171331666.webp)
...
![image-20221027154142690](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171339092.webp)

当再次插入7的时候，这棵树就会发生旋转

![image-20221027154120483](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171346102.webp)
...
![image-20220709002223882](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171351672.webp)
...
![image-20220709002554341](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171354959.webp)



**2-3-4树**

![image-20220709004531952](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171358091.webp)
...
#### 1.3.1. 使用int自增主键后 最大id是10，删除id 10和9，再添加一条记录，最后添加的id是几？删除后重启mysql然后添加一条记录最后id是几？
...
#### 1.6.3. 为什么要回表查询？直接存储数据不可以吗？

为了控制非聚簇索引的大小

#### 1.6.4. 如果把一个 InnoDB 表的主键删掉，是不是就没有主键，就没办法进行回表查询了？
...
![image-20220712002627554](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171405475.webp)





#### 1.7.1. 复合索引创建时字段顺序不一样使用效果一样吗？
...
#### 1.12.2. 能否查看到索引选择的逻辑？是否使用过optimizer_trace？
...
![image-20221028155608009](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171416849.webp)

![img](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171419967.webp)
...
### 2.2. Mysql内部有哪些核心模块组成，作用是什么？

![image-20220627113443003](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171427661.webp)
...
![image-20220702002430362](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171436098.webp)
...
### 2.3. 一条sql发送给mysql后，内部是如何执行的？（说一下 MySQL 执行一条查询语句的内部执行过程？）

1.5、查询流程说明

![image-20220627141453944](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171440086.webp)
...
#### 2.3.1. MySQL 提示“不存在此列”是执行到哪个节点报出的？
...
![image-20220703164220030](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171455104.webp)
...
![image-20220703170334348](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171502173.webp)

### 2.6. Mysql8.0自带哪些存储引擎？分别是做什么的？
...
![img](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171510794.webp)
...
#### 2.7.2. 阿里、京东等大厂都有自研的存储引擎，如何开发一套自己的？
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171525490.webp)
...
![img](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171536775.webp)
...
![img](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171541119.webp)
...
#### 4.3.3. 有没有在开发中使用过TEXT,BLOB 数据类型
...
#### 4.4.1. TIMESTAMP，DATETIME 的区别是什么？
...
#### 4.4.3. 如果需要使用时间戳 timestamp和int该如何选择？
...
#### 4.6.1. 117 decimal与float,double的区别是什么？
...
#### 4.8.2. 123 join查询可以无限叠加吗？Mysql对join查询有什么限制吗？
...
#### 4.8.3. 124  join 查询算法了解吗？

- Simple Nested-Loop Join：SNLJ，简单嵌套循环连接
- Index Nested-Loop Join：INLJ，索引嵌套循环连接
- Block Nested-Loop Join：BNLJ，缓存块嵌套循环连接

#### 4.8.4. 125 如何优化过多join查询关联？
...
#### 4.9.2. 128 如何监控线上环境中执行比较慢的sql？ 129 如何分析一条慢sql？
...
#### 4.9.3. 130 如何查看当前sql使用了哪个索引？

可以使用EXPLAIN，选择索引过程可以使用 optimizer_trace

#### 4.9.4. 131 索引如何进行分析和调优？

#### 4.9.5. 132 EXPLAIN关键字中的重要指标有哪些？
...
![image-20220710101402666](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171556887.webp)
...
![image-20220711122444380](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171600636.webp)
...
![image-20220710000757241](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171603928.webp)
...
![image-20220710000950098](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171607455.webp)
...
![image-20220711123408605](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171610247.webp)
...
![image-20220710001512891](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171613257.webp)
...
![image-20220710001930811](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171617084.webp)
...
![image-20220710002145309](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171620092.webp)
...
![image-20220710002444782](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171623456.webp)
...
![image-20220710002604613](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171626702.webp)
...
![image-20220710003049587](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171630326.webp)
...
![image-20220710110732730](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171633187.webp)
...
![image-20220710153504037](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171636095.webp)
...
![image-20220710153921679](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171638985.webp)
...
![image-20220710155650935](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171642406.webp)
...
![image-20220712065946659](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171647395.webp)
...
![image-20220712065815768](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171651180.webp)
...
![image-20220712065922882](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171654642.webp)
...
![image-20220712070042666](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171658000.webp)
...
![image-20220712070727963](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171701089.webp)
...
![image-20220712070851089](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171707935.webp)
...
![image-20220712070944090](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171712948.webp)
...
![image-20220711125730163](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171719517.webp)
...
![image-20220712071057817](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171726788.webp)
...
![image-20220712071138320](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171733863.webp)
...
![image-20220711132125501](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171741173.webp)
...
![image-20220711131831315](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171748448.webp)
...
![image-20220710142152514](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171755472.webp)
...
![image-20220710130548971](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171801834.webp)
...
![image-20220709211819944](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171810807.webp)
...
![image-20220710131916240](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171818342.webp)
...
![image-20220709212722601](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171825761.webp)
...
![image-20220709231638201](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171830047.webp)
...
![image-20220709215122017](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171833183.webp)
...
![image-20220710181100102](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171837104.webp)
...
![image-20220710172607190](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171840213.webp)
...
![image-20220710172926396](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171843603.webp)
...
![image-20220712071716131](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171847584.webp)

```sql
EXPLAIN SELECT id FROM t1;
```

![image-20220712072055566](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171851064.webp)
...
![image-20220710180257692](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171854759.webp)

**注意：**如果这里的查询条件`只有content1 > 'z'`，那么找到满足条件的索引后也会进行一次索引下推的操作，判断content1 > 'z'是否成立（这是源码中为了编程方便做的冗余判断）

![image-20220712012108900](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171858525.webp)
...
![image-20220710182356817](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171902101.webp)
...
![image-20220710182524371](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171905514.webp)
...
### 4.13. 133 MySQL数据库cpu飙升的话你会如何分析
...
![image-20221106160437906](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171910689.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171915134.webp)   
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171919206.webp)



#### 4.14.2. 136 	什么时候进行分库分表？有没有配合es使用经验？
...
![img](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171924554.webp)

#### 4.14.5. 分库分表后可能会有哪些问题？
...
![image-20221106171251532](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304171932268.webp)

![image-20221106171945037](assets/202410251103631.png)
...
### 4.19. 145 某个表有数千万数据，查询比较慢，如何优化？说一下思路
