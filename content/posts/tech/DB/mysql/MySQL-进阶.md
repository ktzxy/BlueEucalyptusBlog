+++
date = '2024-02-21T21:52:03+08:00'
draft = false
title = 'MySQL 进阶'
slug = "ipdtlj9cot"
description = "MySQL 进阶"
categories = ["📒数据库"]
tags = ["mysql"]
summary = "MySQL 进阶"
series = ["MySql数据库学习系列"]
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306143037318.webp)

#### 1.4.2. LOCAL

本地操作：比如，v2视图是基于v1视图的，如果在v2视图创建的时候指定了检查选项为 `local`，但是v1视图创建时未指定检查选项。则在执行检查时，只会检查v2，不会检查v2的关联视图v1。

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306143039979.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306143058012.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306143115660.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306143120232.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306143148207.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306143154122.webp)
