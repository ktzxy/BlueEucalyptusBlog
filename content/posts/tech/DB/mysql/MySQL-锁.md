+++
date = '2024-02-06T09:27:35+08:00'
draft = false
title = 'MySQL 锁'
slug = "4f9oasi3l7"
description = "MySQL 锁"
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151145761.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151157464.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151206269.webp)

左侧为客户端一，对指定表加了读锁，不会影响右侧客户端二的读，但是会阻塞右侧客户端的写。

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151208973.webp)

**写锁测试**

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151211151.webp)

左侧为客户端一，对指定表加了写锁，会阻塞右侧客户端的读和写。

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151216247.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151222361.webp)

- 当执行SELECT语句时，添加的是元数据共享锁（SHARED_READ），会阻塞元数据排他锁（EXCLUSIVE），之间是互斥的。

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151225115.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151230030.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151232760.webp)

当客户端B，想对这张表加表锁时，会检查当前表是否有对应的行锁，如果没有，则添加表锁，此时就会从第一行数据，检查到最后一行数据，效率较低。

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151234961.webp)

以上示例的处理方式效率太低。因此 InnoDB 提出了一种意向锁（英文名：Intention Locks），就是用于解决该问题。引入意向锁之后，客户端A，在执行 DML 操作时，会对涉及的行加行锁，同时也会对该表加上意向锁。

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151238287.webp)

而其他客户端，在对这张表加表锁的时候，会根据该表上所加的意向锁来判定是否可以成功加表锁，而不用逐行判断行锁情况了。

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151240044.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151252556.webp)

- 间隙锁（Gap Lock）：锁定索引记录间隙（不含该记录），确保索引记录间隙不变，防止其他事务在这个间隙进行 insert，产生幻读。在 RR 隔离级别下都支持。

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151258403.webp)

- 临键锁（Next-Key Lock）：行锁和间隙锁组合，同时锁住数据，并锁住数据前面的间隙 Gap。在 RR 隔离级别下支持。

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151304054.webp)

### 7.3. Record Locks（记录锁）

记录锁，就是仅仅把一条记录锁上，官方的类型名称为：LOCK_REC_NOT_GAP。例如把id值为9的记录加一个记录锁，示意图如下：

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151308954.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151312731.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151319166.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151322231.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151328825.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306151334772.webp)
