+++
date = '2025-03-12T08:05:06+08:00'
draft = false
title = 'MySQL 事务'
slug = "vagl5mvrjc"
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150500911.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150505326.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306153804822.webp)

#### 3.1.2. 不可重复读（Non-Repeatable Read）

一个事务多次读取的数据内容不一致，称之为不可重复读。通常要求是同一个事务中多次读取时数据，结果都应该是一致的。一般是由于另一个事务 `update` 语句修改数据后并提交后引发。

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306153811043.webp)

#### 3.1.3. 幻读（Phantom）

一个事务中多次查询的数据的记录数不一致。要求在一个事务多次读取的数据的数量是一致的，一般是由另一个事务的 `insert` 或 `delete` 引发。

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150511601.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150524346.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150531194.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150535866.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150543780.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150547764.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150553888.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150602751.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150607745.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150610317.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150614610.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150620055.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150626096.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150632163.webp)

- 实现 REPEATABLE READ 隔离级别，事务里每次执行查询操作时都是使用第一次查询时生成的 readview，也就是都是以第一次查询时当时数据库里所有事务提交状态来比对数据是否可见，因此可以实现每次查询的可重复读的效果。

![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150638015.webp)
...
![流程图-MVCC多版本并发控制.drawio](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150641065.webp)

![流程图-MVCC多版本并发控制.drawio](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150650913.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150703264.webp)
...
![](https://fastly.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260306150708193.webp)
