...
![运行Redis服务](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304175823793.webp)
...
![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304175830209.webp)
...
![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304175837705.webp)
...
![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304175844878.webp)
...
![一主一从](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304175850448.webp)

- **一主多从**：针对“读”较多的场景，“读”由多个从节点来分担，但节点越多，主节点同步到多节点的次数也越多，影响带宽，也加重主节点的稳定

![一主多从](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304175858010.webp)

- **树状主从**：一主多从的缺点（主节点推送次数多压力大）可用些方案解决，主节点只推送一次数据到从节点1，再由从节点2推送到11，减轻主节点推送的压力

![树状主从](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304175853643.webp)

### 3.3. 主从数据复制的原理

Redis 提供了复制功能，可以实现在主数据库（Master）中的数据更新后，自动将更新的数据同步到从数据库（Slave）。一个主数据库可以拥有多个从数据库，而一个从数据库只能拥有一个主数据库。主从数据复制原理图如下：

![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304175903898.webp)
...
![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304175909917.webp)
...
![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304175915399.webp)
...
![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304175922769.webp)
...
![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/20260304175934487.webp)
