+++
date = '2024-02-25T03:11:00+08:00'
draft = false
title = 'SpringMVC'
slug = "ku9r5s6zi6"
...
>
> ...Modules名\src\main\webapp\WEB-INF\web.xml
...
名称：<servlet-name>-serverlet.xml, 当前配置下的配置文件名为SpringMVC-servlet.xml
...
```html
<a th:href="@{test/session}">使用向会话域共享数据</a><br>
...
/**
 * @Auther: 赵羽
 * @Date: 2023/4/30 - 04 - 30 - 19:47
 * @Description: com.hbnu.pojo
 * @version: 1.0
 */
...
/**
 * @Auther: 赵羽
 * @Date: 2023/4/30 - 04 - 30 - 19:50
 * @Description: com.hbnu.dao
 * @version: 1.0
 */
@Repository
...
```xml
<bean class="com.hbnu.interceptor.FirstInterceptor"></bean>
