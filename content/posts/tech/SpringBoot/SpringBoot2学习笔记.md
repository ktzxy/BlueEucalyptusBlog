+++
date = '2025-03-04T00:52:00+08:00'
draft = false
title = 'SpringBoot2学习笔记'
slug = "bkjzuy1c2e"
description = "SpringBoot2学习笔记"
categories = ["📒开发"]
tags = ["SpringBoot"]
summary = "SpringBoot2学习笔记"
comments = true  
+++
...
[JamesLewis and Martin Fowler(2014)](https://martinfowler.com/articles/microservices.html) 提出微服务完整概念。https://martinfowler.com/articles/microservices.html
...
- 默认的包结构
	...
	- 无需以前的包扫描配置
	- 想要改变扫描路径
		- @SpringBootApplication(scanBasePackages="com.hbnu")
...
## 28、请求处理-【源码分析】-请求映射原理
![在这里插入图片描述](assets/202311282213009_38e4dd.png)
