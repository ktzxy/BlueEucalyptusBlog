+++
date = '2024-03-28T03:45:50+08:00'
draft = false
title = 'prometheus+alertmanager+webhook实现钉钉告警'
slug = "c2r6qt27h2"
description = "prometheus+alertmanager+webhook实现钉钉告警"
categories = ["📒运维"]
tags = ["监控"]
summary = "prometheus+alertmanager+webhook实现钉钉告警"
comments = true  
series = ["Prometheus系列"]
showSeries= true
+++
