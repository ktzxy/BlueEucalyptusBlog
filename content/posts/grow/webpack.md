...
![Webpack打包流程图](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202507231849714.webp)
...
![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202507231849716.webp)

- 输入`nrm ls`命令，查看镜像是否已经指向taobao。注：带“`*`”号的为目前使用的镜像

![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202507231849717.webp)
...
![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202507231849718.webp)
...
![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202507231849719.webp)
...
![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202507231849721.webp)

### 10.4. 自动清理 dist 目录下的旧文件

为了在每次打包发布时自动清理掉 dist 目录中的旧文件，可以安装并配置 clean-webpack-plugin 插件：

![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202507231849722.webp)
...
![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202507231849723.webp)

![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202507231849724.webp)

开发环境下默认生成的 Source Map，记录的是生成后的代码的位置。会导致运行时报错的行数与源代码的行数不一致的问题。示意图如下：

![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202507231849725.webp)
...
![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202507231849726.webp)

![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202507231849727.webp)

##### 10.5.4.1. 只定位行数不暴露源码

在生产环境下，如果只想定位报错的具体行数，且不想暴露源码。此时可以将 `devtool` 的值设置为 `nosources-source-map`。实际效果如图所示：

![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202507231849728.webp)

![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202507231849729.webp)

##### 10.5.4.2. 定位行数且暴露源码

在生产环境下，如果想在定位报错行数的同时，展示具体报错的源码。此时可以将 `devtool` 的值设置为 `source-map`。实际效果如图所示：

![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202507231849730.webp)

![](https://cdn.jsdelivr.net/gh/ktzxy/blog-img@main/2026/202507231849731.webp)
